...
<tr><td id="const1">Faculty Full Name:</td><td style="{width:500;//color:white;}"><b><p style={text-transform:uppercase}><?php echo $row['first']."  ";?> <?php echo $row['last'];?><br><font size=2>S/o:<?php echo $row['father'];?></font></b></td><td><img src="profile-face/<?php echo $_SESSION['user']; ?>.jpg" id="img"></td></tr>
...
<tr><td id="const1">Faculty Resume:</td><td id="const2"><a href="viewPDF.php?id=<?php echo $row['uname'];?>&vtype=student"><?php echo $row['uname'];?></a></td></tr>
</table></fieldset>
